...
// in simulator we redefine to format for wikkitt Developer console
...
{\
	NSString * exceptionName = [@"org.wikkitt." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wikkitt";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIwikkittNativeItemNone = -1, 
	UIwikkittNativeItemSpinner = -2,
	UIwikkittNativeItemProgressBar = -3,
	
	UIwikkittNativeItemSlider = -4,
	UIwikkittNativeItemSwitch = -5,
	UIwikkittNativeItemMultiButton = -6,
	UIwikkittNativeItemSegmented = -7,
	
	UIwikkittNativeItemTextView = -8,
	UIwikkittNativeItemTextField = -9,
	UIwikkittNativeItemSearchBar = -10,
	
	UIwikkittNativeItemPicker = -11,
	UIwikkittNativeItemDatePicker = -12,
	
	UIwikkittNativeItemInfoLight = -13,
	UIwikkittNativeItemInfoDark = -14,
	
	UIwikkittNativeItemDisclosure = -15,
	
	UIwikkittNativeItemContactAdd = -16
};
