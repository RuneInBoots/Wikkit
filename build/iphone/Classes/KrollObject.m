...
//@interface wikkittObject : NSObject
//@end

@interface wikkittObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[wikkittObject class]])
		{
			for (NSString *key in [[(wikkittObject*)o modules] allKeys])
			{
