...
function loadTweets()
{
	...
	loader.open("GET","http://api.twitter.com/1/statuses/user_timeline.json?screen_name=AnneliesDeleu");
	...
	loader.onload = function() 
	{
		...
		var tableView = Titanium.UI.createTableView({data:rowData, minRowHeight: 65});
